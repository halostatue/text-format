...
* Modernized gem packaging with 'hoe'; removed all other installers.
  Thanks to Ryan Tate <ryantate@ryantate.com> for the impetus to do this, even
  if it did take a few months to find the time.
* Adding Travis and Code Climate.
* Testing against modern Ruby versions.
